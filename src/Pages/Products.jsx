            ...
            value && (
                ...
                <div className='flex flex-col-reverse md:flex-row max-w-screen'>
                    <div className="space-y-5 flex-1 px-10">
                        ...
                        <button type="button" class="text-white bg-black hover:bg-black focus:ring-4 focus:ring-black-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-black-600 dark:hover:bg-black-700 focus:outline-none dark:focus:ring-black-800">Add to Cart</button>
                    </div>
    ...
    <div className="grid place-items-center w-screen px-4 md:px-8 lg:px-16">
                    ...
                    <div className='grid gap-4 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 mt-5 w-screen'>
                        {map}
                    </div>
