...
const HomePage = () => {
  ...
  return (
    ...
    <div role="status" className="flex justify-center items-center text-center w-full h-screen">
      <svg aria-hidden="true" className="inline w-28 h-28 text-gray-200 animate-spin dark:text-gray-600 fill-blue-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
